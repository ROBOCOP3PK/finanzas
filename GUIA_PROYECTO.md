...
## 12. Sistema PWA y Funcionamiento Offline

> **Nota:** La documentación del servidor (despliegue, Cloudflare Tunnel, Nginx, etc.) se encuentra en [SERVER.md](SERVER.md)

### 12.1 Arquitectura PWA
...
### 12.2 Archivos del Sistema Offline
...
### 12.3 Estrategias de Caché (Service Worker)
...
### 12.4 Cola de Operaciones Offline
...
## 13. Sistema de Tema Oscuro (Dark Mode)
...
## 14. Sistema de Ciclos de Facturación de Servicios
...
### 14.6 Copiar Referencia con Doble-Click
...
## 15. Navegación desde Alertas

### 15.1 Tipos de Alertas y Destinos
...
### 15.2 Navegación a Servicios desde Notificaciones
...
## 16. Exportación y Compartir

### 16.1 Exportación a CSV
...
## 17. Resumen de Funcionalidades Completas

### 17.1 Funcionalidades por Módulo
...
### 17.2 Comandos Artisan Disponibles
...
> **Nota:** La documentación del servidor (despliegue, Cloudflare Tunnel, Nginx, agregar nuevas apps) se encuentra en [SERVER.md](SERVER.md)
